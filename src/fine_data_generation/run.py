...
if __name__ == '__main__':
    try:
        import pyrallis  # optional; only needed for the CLI
    except ImportError as e:
        raise SystemExit(
            "pyrallis is required only for the CLI entrypoint.\n"
            "Install it with: pip install pyrallis\n"
            "Or import and call run.main(...) from Python without pyrallis."
        ) from e
